...
public class SomeSiteTest {
	...
	public void homePage(){
		...
		element = driver.findElement(By.linkText("załóż konto"));
	...
	public void rejestracja(){
		...
		driver.findElement(By.id("plec-mężczyzna")).click();
		...
		oSelect.selectByVisibleText("wieś");
		oSelect = new Select(driver.findElement(By.name("wyksztalcenie")));
		oSelect.selectByVisibleText("średnie");
		...
		//sprawdzamy czy wyczy�ci�o text field"
